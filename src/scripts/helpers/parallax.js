...
function initializeParallax(clip) {
    ...
    // longer be visible.
    clip.addEventListener('scroll', function(e) {
...
function onResize(details) {
    for (var i = 0; i < details.length; i++) {
        ...
        var marginTop = details[i].node.getAttribute('margin-top');
        ...
        var dy = details[i].sticky ?
            ...
            (parallaxStart - depth * (height - marginTop * (1 - scale) - clip.clientHeight)) * scale;
